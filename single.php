      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="h2 mb-0"><strong>Dog</strong>Life<span
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <div class="row mb-5">
              <div class="col-lg-12">
                <figure><img src="images/dog_1.jpg" alt="Free Website Template by Free-Template.co"
                    class="img-fluid">
                  <figcaption>This is an image caption</figcaption>
                </figure>
              </div>
              <div class="col-lg-12">
                <figure><img src="images/dog_2.jpg" alt="Free Website Template by Free-Template.co"
                    class="img-fluid">
                  <figcaption>This is an image caption</figcaption>
                </figure>
              </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p>
                <!-- Link back to Homepage,inc. can't be removed. Template is licensed under CC BY 3.0. -->
                Copyright &copy;
                <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made
                with <i class="icon-heart-o" aria-hidden="true"></i> by <a href="https://best-homepage.com/"
                  target="_blank">Homepage,inc.</a>
                <!-- Link back to Homepage,inc. can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
